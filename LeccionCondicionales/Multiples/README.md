...
## Números Romanos <a name="alg5"></a>
Desarrollar un algoritmo que dado un número romano entre I y C me despliegue el respectivo número en decimal. 
Ejemplo: 
- I 1
- XX 20
